    ...
    <div class="wrapper">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown">
                        ...
                        <a href="<?= base_url('configuration/change_password'); ?>" class="dropdown-item">
                            <i class="fa fa-lock-open fa-fw mr-2"></i> Ubah Password
                        </a>
                        <div class="dropdown-divider"></div>
                        <a href="#logoutModal" class="dropdown-item" data-toggle="modal">
                            <i class="fa fa-sign-out-alt fa-fw mr-2"></i> Logut
                        </a>
                    </div>
                </li>
                <li class="nav-item">
        ...
        <aside class="main-sidebar sidebar-dark-primary sidebar-no-expand">
            ...
            <a href="<?= base_url('dashboard') ?>" class="brand-link navbar-dark">
                <img src="<?= base_url(); ?>assets/dist/img/logo.png" alt="Logo" class="brand-image img-circle">
                <span class="brand-text text-white">Islam Skuy</span>
            </a>
