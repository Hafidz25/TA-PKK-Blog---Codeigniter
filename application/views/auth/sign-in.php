    ...
    <div class="flex-fill d-flex flex-column justify-content-center py-4">
        <div class="container-tight py-6">
            ...
            <div class="card-body">
                ...
                <h2 class="card-title text-center mb-4">Login disini yaa</h2>
                <div class="mb-3">
                    <label class="form-label">Username</label>
                    <input autofocus onfocus="this.select()" value="<?= set_value('username'); ?>" name="username" type="text" class="form-control" placeholder="Masukan Username">
                    <?= form_error('username'); ?>
                </div>
                <div class="mb-2">
                    <label class="form-label">Password</label>
                    <div class="input-group input-group-flat">
                        <input name="password" type="password" class="form-control" placeholder="Masukan Password" autocomplete="off">
            ...
            <div class="text-center text-muted mt">
                Belum punya akun? <a href="<?= base_url("signup"); ?>" tabindex="-1">Register</a>
            </div>
        </div>
    </div>
    <!-- Libs JS -->
